...
In this chapter, the calendar correction used in JDemetra+ is discussed.
...
As calendar effects are deterministic, they can be corrected with a regression model. In the algorithms X-13-ARIMA and Tramo-Seats it boils down to adding suitable regressors to the [pre-treatment phase](#sa-pre-t)). This chapter will describe how to generate a set of regressors corresponding to the desired correction, which will happen according to the following steps:  
...
<!-- - 5 jeux de regresseurs et une possibilité de les selectionner automatiquement selon 3 critères statistiques différents -->
